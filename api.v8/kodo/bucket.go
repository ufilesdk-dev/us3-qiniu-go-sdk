...
func (p Bucket) List(
	...
	listUrl := p.makeListURL(prefix, marker, limit, false)
...
func (p Bucket) ListWithParts(
	...
	listUrl := p.makeListURL(prefix, marker, limit, true)
...
func (p Bucket) makeListURL(prefix, marker string, limit int, needParts bool) string {
